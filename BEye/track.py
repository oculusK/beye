...
from yolov7.utils.dataloaders import VID_FORMATS, LoadImages, LoadStreams
from yolov7.utils.general import (LOGGER, check_img_size, non_max_suppression, scale_boxes, check_requirements, cv2,
                                  check_imshow, xyxy2xywh, increment_path, strip_optimizer, colorstr, print_args, check_file)
from yolov7.utils.torch_utils import select_device, time_sync
from yolov7.utils.plots import Annotator, colors, save_one_box
...
def parse_opt():
    ...
    parser.add_argument('--yolo-weights', nargs='+', type=Path, default=WEIGHTS / 'yolov7.pt', help='model.pt path(s)')
